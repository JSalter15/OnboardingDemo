...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var loggedInNavController:UINavigationController?
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        loggedInNavController = UINavigationController(rootViewController: loggedInViewController)
    ...
    func navigateToLoggedInNavigationController() {
        self.window?.rootViewController = self.loggedInNavController
        self.window?.makeKeyAndVisible()
    }
